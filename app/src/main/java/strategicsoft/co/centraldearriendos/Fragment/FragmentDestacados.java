...
import strategicsoft.co.centraldearriendos.Adapter.BucketListAdapterDestacados;
...
public class FragmentDestacados extends BaseVolleyFragment {
    ...
    private static CustomAdapterMapa adapter;
                            ...
                            protected void onPostExecute(Long result){
                              //  Toast.makeText(getActivity(), mModeloDestacado.toString(), Toast.LENGTH_SHORT).show();
                                if(validarDatosServicio() == false){
                                    ...
                                    adapter = new CustomAdapterMapa(problemaActivity, mModeloDestacado);
    ...
    public class CustomAdapterMapa extends BucketListAdapterDestacados<String> {

        private Activity mActivity;
        private List<ModeloListaDestacados> items;
        private ImageLoader imageLoader1;
        private DisplayImageOptions options1;
        public CustomAdapterMapa(Activity ctx, List<ModeloListaDestacados> elements) {
            super(ctx, elements);
            this.mActivity=ctx;
            this.items=elements;
